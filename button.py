...
class DreamCheekyThread(threading.Thread, abc.ABC):
    def __init__(self,
                 device: usb.core.Device,
                 event_handler: typing.Callable[['DreamCheekyEvent'], None] = None,
...
class DreamCheekyEvent(abc.ABC):
...
if __name__ == '__main__':  
    ...
    while True:
        ...
        if event.type == ButtonEventType.LID_OPEN:
            print("Lid Opened")
        elif event.type == ButtonEventType.BUTTON_PRESS:
